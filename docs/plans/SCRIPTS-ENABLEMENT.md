...
> **Tracked in GitHub Issues: legacy AFF-30.**
> Delete this file when AFF-30 is closed. Planning is tracked in GitHub Issues, not here — see [`docs/plans/README.md`](./README.md).
