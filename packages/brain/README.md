...
`docs/reference/brain/README.md` (approvals gate section).
...
- [`docs/reference/brain/README.md`](../../docs/reference/brain/README.md) — the landing doc (A-Z index)
- [`docs/reference/brain/TECHNICAL.md`](../../docs/reference/brain/TECHNICAL.md) — debug-level technical reference
- [`docs/reference/brain/STATUS.md`](../../docs/reference/brain/STATUS.md) — v1/v2 status and roadmap tracker
