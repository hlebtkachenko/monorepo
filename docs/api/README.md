...
variables are registered in [`docs/ENVIRONMENT-VARIABLES.md`](../ENVIRONMENT-VARIABLES.md).
...
The Scalar reference is one surface. Current API guidance lives here. Future
contracts live under [`specs/api/`](../specs/api/).
...
| [`SANDBOX.md`](../specs/api/SANDBOX.md)      | `affk_test_…` keys, seeded fixtures, force-trigger endpoints              | Concept                               |
| [`WEBHOOKS.md`](../specs/api/WEBHOOKS.md)    | Standard Webhooks contract, delivery and signature rules                  | Concept                               |
