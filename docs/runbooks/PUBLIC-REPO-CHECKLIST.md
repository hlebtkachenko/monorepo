...
| Require signed commits                                           | **ON** _(after you set up signing in section 5)_                                 | Audit trail integrity.                                                                                                                                     |
...
```sh
ssh-keygen -t ed25519 -C "support+github@afframe.com"
...
mkdir -p ~/.config/git
echo "support+github@afframe.com $KEY" > ~/.config/git/allowed_signers
