...
- **Debug** _(dev reference)_ — **Debug** landing · **Archetype Blank** (the Blank archetype reference page: ContentHeader without view tabs · no toolbar · one full-height Empty section · no footer)
