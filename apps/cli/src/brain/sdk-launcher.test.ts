...
describe("makeCanUseTool (RUN/BOOK lane live gate)", () => {
  ...
  it("allows the pinned capture tool and echoes the input VERBATIM (no client-side rewrite of the write body)", async () => {
    const input = {
      foo: "bar",
    ...
    // was dead, and the write is submitted exactly as inspected. updatedInput is the input, unmodified.
