...
Full picture + tiers: [`SECRETS-AND-VARIABLES.md`](../reference/SECRETS-AND-VARIABLES.md). Vault ops + exact
...
4. Document the var in [`../reference/ENVIRONMENT-VARIABLES.md`](../reference/ENVIRONMENT-VARIABLES.md).
