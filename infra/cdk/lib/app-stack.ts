...
export class AppStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: AppStackProps) {
    ...
    //
    // See docs/reference/SECRETS-MIGRATION-HISTORY.md § M4.
    ...
    const webContainer = taskDef.addContainer("web", {
      ...
      environment: {
        ...
        // │  docs/plans/LAUNCH-CHECKLIST.md #7. Telegram ask NOT yet sent (no
    ...
    const adminContainer = taskDef.addContainer("admin", {
      ...
      environment: {
        ...
        // Hleb's approval — docs/plans/LAUNCH-CHECKLIST.md #7).
        BETTER_AUTH_COOKIE_DOMAIN: deriveCookieDomain(props.adminDomain),
    ...
    //
    // openfga/openfga:v1.18.1 is a Chainguard distroless image — no
    ...
    const openfgaContainer = taskDef.addContainer("openfga", {
      ...
      image: ContainerImage.fromRegistry("openfga/openfga:v1.18.1"),
      essential: true,
      logging: LogDriver.awsLogs({
