...
- Storybook addons: docs, a11y, themes, links, chromatic, vitest, test-runner
...
- WebKit (Safari) browser testing via Playwright
- ARCHITECTURE.md system architecture reference
- CHANGELOG.md
- Domain rules in AGENTS.md (Money, RLS, AI schemas)
- Full stack quick-start section in README (TBA)
