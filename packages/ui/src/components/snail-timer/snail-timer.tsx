...
interface SnailTimerProps extends React.ComponentProps<"div"> {
...
function SnailTimer({
  ...
  return (
    <div
      ...
      className={cn(
        "snail-timer pointer-events-none relative w-full overflow-hidden",
        finished && "is-paused",
        className,
      )}
    ...
    >
      ...
      <div
        ...
        style={
          {
            "--snail-move-duration": `${initialSeconds}s`,
      ...
      <g fill="none" fillRule="evenodd" transform="translate(2 2)">
        <g className="left-eye">
          <g transform="translate(0 17.101)">
            ...
            />
            <path
              fill="color-mix(in oklab, var(--purple) 70%, transparent)"
        ...
        <g className="shell">
          <g strokeLinecap="round" transform="translate(48.357 .18)">
            <path
              stroke="color-mix(in oklab, var(--purple) 70%, transparent)"
