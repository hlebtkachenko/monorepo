...
| `bank_account`     | 2     | One Kč (KB `0100`), one EUR (Fio `2010`) — see [`SECRETS.md`](../reference/SECRETS-AND-VARIABLES.md) for sandbox redaction |
...
- Sandbox keys never expire automatically. Live keys roll on 90 days ([`API-PUBLIC-LAUNCH.md`](../plans/API-PUBLIC-LAUNCH.md) §1.7).
...
- [`ERRORS.md`](./ERRORS.md), [`WEBHOOKS.md`](./WEBHOOKS.md), [`API-PUBLIC-LAUNCH.md`](../plans/API-PUBLIC-LAUNCH.md)
