...
import { CalendarIcon, XCircle } from "@workspace/ui/lib/icons"
...
export function DataTableDateFilter<TData>({
  ...
  const label = React.useMemo(() => {
    if (multiple) {
      ...
      const has = Boolean(selectedDates.from || selectedDates.to)
      const text = has ? formatRange(selectedDates) : "Select date range"
      return (
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button
          data-slot="data-table-date-filter-trigger"
          variant="outline"
          size="sm"
