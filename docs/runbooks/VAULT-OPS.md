...
| Restic password         | VPS `/root/.config/restic/.env` (mode 0600, root) + **paper at safe-deposit**. NOT in macOS Keychain (verified 2026-05-31). The running backup timer proves the value is valid on the VPS. |
