...
// this avoids.
//
// Regenerate:  pnpm --filter web exec tsx app/vykazy/_lib/build-reference.ts
...
import type { VykazLine, VykazStatement } from "./types"
...
function main(): void {
  ...
  const doc = `<!-- GENERATED by apps/web/app/vykazy/_lib/build-reference.ts — do not edit by hand.
     Regenerate: pnpm --filter web exec tsx app/vykazy/_lib/build-reference.ts -->
