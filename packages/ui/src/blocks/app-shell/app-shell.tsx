  ...
  return (
    <AppShellContext.Provider value={shellContext}>
      ...
      >
        ...
        <div className="absolute top-[var(--shell-header-height)] right-[var(--shell-right-inset)] bottom-[var(--shell-bottom-inset)] left-[var(--shell-rail-width)] flex transition-[left] duration-200 ease-in-out">
          <div
          ...
          {assistantOpen && assistant !== undefined && (
            <>
              <div
                ...
                className="w-[var(--shell-handle-width)] shrink-0 cursor-col-resize touch-none bg-transparent select-none"
              />
              <aside
                data-slot="app-shell-assistant"
                style={{ width: assistantWidth }}
                className={cn(
                  "h-full shrink-0 overflow-x-hidden overflow-y-auto",
