...
describe("drizzle schema mirrors the migrations", () => {
  ...
  it("declares every enum with the same labels, in the same order", async () => {
    ...
    expect(
      ...
      beta_account_kind: [...betaAccountKind.enumValues],
      beta_account_match_kind: [...betaAccountMatchKind.enumValues],
      ...
      beta_chat_role: [...betaChatRole.enumValues],
      beta_client_task_link_kind: [...betaClientTaskLinkKind.enumValues],
      beta_client_task_status: [...betaClientTaskStatus.enumValues],
      ...
      beta_indicator_kind: [...betaIndicatorKind.enumValues],
      beta_loan_installment_period: [...betaLoanInstallmentPeriod.enumValues],
      beta_loan_kind: [...betaLoanKind.enumValues],
      beta_obligation_group: [...betaObligationGroup.enumValues],
      beta_org_role: [...betaOrgRole.enumValues],
      beta_partner_role: [...betaPartnerRole.enumValues],
      beta_partner_source: [...betaPartnerSource.enumValues],
      beta_payroll_contract_type: [...betaPayrollContractType.enumValues],
