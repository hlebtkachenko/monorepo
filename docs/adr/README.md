...
| [0025](0025-brain-runtime-placement.md)               | Afframe Brain runtime: external client for v1 (amended)                    | Accepted           |
| [0026](0026-brain-confidence-model.md)                | Afframe Brain confidence: infra-gated, calibrated, not model-verbalized    | Accepted           |
| [0027](0027-brain-learning-artifact-store.md)         | Afframe Brain learning artifacts: `.brain/` git tree, written via PR       | Accepted           |
| [0028](0028-brain-marshrutizator-isolation.md)        | Afframe Brain marshrutizátor: admission + per-(org,period) write isolation | Accepted           |
| [0029](0029-brain-learned-state-workspace-scoped.md)  | Brain learned state (OCR templates, KB/memory-as-data) is workspace-scoped | Accepted           |
| [0030](0030-statutory-periods-and-legal-dates.md)     | Statutory periods and legal dates are independent of accounting periods    | Proposed           |
| [0031](0031-s3-storage-and-document-working-store.md) | S3 storage classes and document working store                              | Accepted           |
