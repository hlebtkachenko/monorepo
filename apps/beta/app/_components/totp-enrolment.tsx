 ...
 * finds out.
 *
 * NO QR IMAGE, deliberately. Rendering one needs a QR encoder, which is a new
 * runtime dependency and therefore a `pnpm-lock.yaml` change — a full cold
 * rebuild of every package in the monorepo, bought for a convenience every
 * authenticator app already offers a path around: the `otpauth://` URI is a
 * link the app itself can open, and the secret below it is the manual-entry
 * path. Adding a QR later is a self-contained change to this one component.
 *
